<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div style="text-align: center" v-if="myOrder.records === undefined">
        暂无订单
      </div>
      <div class="chosetype" v-if="myOrder.records !== undefined">
        <table>
          <thead>
            <tr>
              <th width="29%">商品</th>
      ...
      <div class="orders" v-if="myOrder.records !== undefined">
        <!-- 每一笔订单 -->
        <table
          class="order-item"
      ...
      <div class="choose-order">
        <!-- 分页器 -->
        <Pagination
          v-if="myOrder.records !== undefined"
          :currentPage="page"
          :pageSize="limit"
          :total="myOrder.total"
          :showPageNo="5"
